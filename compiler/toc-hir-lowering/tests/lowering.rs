...
fn lower_complex_real_literal() {
    ...
    let tests = vec![
        ...
        (
            "C76",
            0x0006c9a143590c14_u64,
            "94393431193180696942841837085033647913224148539854e-358",
        ),
        (
            "C79",
            0x0007802665fd9600_u64,
...
fn lower_function_tys() {
    ...
    // Nesting
    assert_lower!(
        "type _ : function _ (function a (function a : int ) : int, proc b (proc a (proc a( proc a))), proc c) : int"
    );
