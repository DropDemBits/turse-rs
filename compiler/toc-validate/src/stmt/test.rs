...
fn report_mismatched_fcn_names() {
    check(
        "fcn a() : int end b",
        expect![[r#"
            error at 18..19: mismatched identifier names
            | note for 4..5: `a` does not match...
            | note for 18..19: ...`b` defined here"#]],
    );
}
...
fn report_mismatched_process_names() {
    check(
        "process a() end b",
        expect![[r#"
            error at 16..17: mismatched identifier names
            | note for 8..9: `a` does not match...
            | note for 16..17: ...`b` defined here"#]],
    );
}
...
fn report_mismatched_body_proc_names() {
    check(
        ...
        expect![[r#"
            error at 16..17: mismatched identifier names
            | note for 10..11: `a` does not match...
            | note for 16..17: ...`b` defined here"#]],
    );
}
...
fn report_mismatched_body_fcn_names() {
    check(
        ...
        expect![[r#"
            error at 26..27: mismatched identifier names
            | note for 14..15: `a` does not match...
            | note for 26..27: ...`b` defined here"#]],
    );
}
...
fn report_mismatched_body_plain_names() {
    check(
        "body a end b",
        expect![[r#"
            error at 11..12: mismatched identifier names
            | note for 5..6: `a` does not match...
            | note for 11..12: ...`b` defined here"#]],
    );
}
...
fn report_process_decl_in_monitor_class() {
    check(
        ...
        expect![[r#"
            ...
            | error for 16..31: `process` declarations are not allowed in classes or monitor classes"#]],
    );
}
...
fn report_process_decl_in_class() {
    check(
        ...
        expect![[r#"
            ...
            | error for 8..23: `process` declarations are not allowed in classes or monitor classes"#]],
    );
}
...
fn report_return_stmt_in_unit() {
    check(
        "unit return",
        expect![[r#"
            error at 5..11: invalid unit file
            | error for 5..11: expected a module, class, or monitor declaration
            error at 5..11: cannot use `return` here
            | error for 5..11: `return` statement is only allowed in subprogram bodies and module-kind declarations"#]],
    );
}
...
fn report_return_stmt_in_function_body() {
    check(
        ...
        expect![[r#"
            error at 17..23: cannot use `return` here
            | error for 17..23: `result` statement is used to return values in function bodies"#]],
    );
}
...
fn report_result_stmt_in_main() {
    check(
        "result 'uwu'",
        expect![[r#"
            error at 0..12: cannot use `result` here
            | error for 0..12: `result` statement is only allowed in function bodies"#]],
    );
}
...
fn report_result_stmt_in_unit() {
    check(
        "unit result 'uwu'",
        expect![[r#"
            error at 5..17: invalid unit file
            | error for 5..17: expected a module, class, or monitor declaration
            error at 5..17: cannot use `result` here
            | error for 5..17: `result` statement is only allowed in function bodies"#]],
    );
}
...
fn report_result_stmt_in_module_body() {
    check(
        ...
        expect![[r#"
            error at 9..21: cannot use `result` here
            | error for 9..21: `result` statement is only allowed in function bodies"#]],
    );
}
...
fn report_result_stmt_in_procedure_body() {
    check(
        ...
        expect![[r#"
            error at 12..24: cannot use `result` here
            | error for 12..24: `result` statement is only allowed in function bodies"#]],
    );
}
...
fn report_result_stmt_in_process_body() {
    check(
        ...
        expect![[r#"
            error at 10..22: cannot use `result` here
            | error for 10..22: `result` statement is only allowed in function bodies"#]],
    );
}
...
fn report_pre_stmt_in_module_inner() {
    check(
        ...
        expect![[r#"
            error at 15..23: cannot use `pre` statement here
            | error for 15..23: `pre` statement is only allowed at the top level of module-likes and subprograms"#]],
    );
}
...
fn report_pre_stmt_in_subprogram_inner() {
    check(
        ...
        expect![[r#"
            error at 13..21: cannot use `pre` statement here
            | error for 13..21: `pre` statement is only allowed at the top level of module-likes and subprograms"#]],
    );
}
...
fn report_init_stmt_in_subprogram_inner() {
    check(
        ...
        expect![[r#"
            error at 13..26: cannot use `init` statement here
            | error for 13..26: `init` statement is only allowed at the top level of subprograms"#]],
    )
}
...
fn report_post_stmt_in_module_inner() {
    check(
        ...
        expect![[r#"
            error at 15..24: cannot use `post` statement here
            | error for 15..24: `post` statement is only allowed at the top level of module-likes and subprograms"#]],
    );
}
...
fn report_post_stmt_in_subprogram_inner() {
    check(
        ...
        expect![[r#"
            error at 13..22: cannot use `post` statement here
            | error for 13..22: `post` statement is only allowed at the top level of module-likes and subprograms"#]],
    );
}
...
fn report_handler_stmt_in_subprogram_inner() {
    check(
        ...
        expect![[r#"
            error at 13..37: cannot use `handler` statement here
            | error for 13..37: `handler` statement is only allowed at the top level of subprograms"#]],
    );
}
...
fn report_inherit_stmt_in_class_inner() {
    check(
        ...
        expect![[r#"
            error at 14..25: cannot use `inherit` statement here
            | error for 14..25: `inherit` statement is only allowed in classes"#]],
    );
}
...
fn report_inherit_stmt_in_monitor_class_inner() {
    check(
        ...
        expect![[r#"
            error at 22..33: cannot use `inherit` statement here
            | error for 22..33: `inherit` statement is only allowed in classes"#]],
    );
}
...
fn report_inherit_stmt_in_module() {
    check(
        ...
        expect![[r#"
            error at 9..20: cannot use `inherit` statement here
            | error for 9..20: `inherit` statement is only allowed in classes"#]],
    );
}
...
fn report_implement_stmt_in_module_inner() {
    check(
        ...
        expect![[r#"
            error at 15..28: cannot use `implement` statement here
            | error for 15..28: `implement` statement is only allowed in module-like blocks"#]],
    );
}
...
fn report_implement_stmt_in_top_level() {
    check(
        "implement sus",
        expect![[r#"
            error at 0..13: cannot use `implement` statement here
            | error for 0..13: `implement` statement is only allowed in module-like blocks"#]],
    );
}
...
fn report_implement_by_stmt_in_module_inner() {
    check(
        ...
        expect![[r#"
            error at 15..31: cannot use `implement by` statement here
            | error for 15..31: `implement by` statement is only allowed in module-like blocks"#]],
    );
}
...
fn report_implement_by_stmt_in_top_level() {
    check(
        "implement by sus",
        expect![[r#"
            error at 0..16: cannot use `implement by` statement here
            | error for 0..16: `implement by` statement is only allowed in module-like blocks"#]],
    );
}
...
fn report_import_stmt_in_unit() {
    check(
        ...
        expect![[r#"
            ...
            error at 5..14: cannot use `import` statement here
            | error for 5..14: `import` statement is only allowed at the top level of subprograms, module-likes, or programs"#]],
    );
}
...
fn import_stmt_in_program_inner() {
    check(
        "begin import () end",
        expect![[r#"
            error at 6..15: cannot use `import` statement here
            | error for 6..15: `import` statement is only allowed at the top level of subprograms, module-likes, or programs"#]],
    );
}
...
fn report_import_stmt_in_body() {
    check(
        ...
        expect![[r#"
            error at 7..21: useless `import` statement
            | error for 7..21: `import` statements are ignored in `body` declaration"#]],
    );
}
...
fn report_export_stmt_in_module_inner() {
    check(
        ...
        expect![[r#"
            error at 15..23: cannot use `export` statement here
            | error for 15..23: `export` statement is only allowed in module-like blocks"#]],
    );
}
...
fn report_export_stmt_in_program_level() {
    check(
        "export()",
        expect![[r#"
            error at 0..8: cannot use `export` statement here
            | error for 0..8: `export` statement is only allowed in module-like blocks"#]],
    );
}
...
fn report_forward_attr_in_plain_import() {
    check(
        "import forward owo",
        expect![[r#"
            error at 7..14: cannot use `forward` attribute here
            | error for 7..14: `forward` attribute can only be used in `forward` declarations"#]],
    );
}
...
fn report_external_item_explicit_path_in_program_level_inner() {
    check(
        ...
        expect![[r#"
            error at 6..18: cannot use `import` statement here
            | error for 6..18: `import` statement is only allowed at the top level of subprograms, module-likes, or programs
            error at 13..18: cannot use external path here
            | error for 13..18: external paths can only be used in top-level `import` statements"#]],
    )
}
...
fn report_external_item_explicit_path_in_forward_decl() {
    check(
        ...
        expect![[r#"
            error at 24..29: cannot use external path here
            | error for 24..29: external paths can only be used in top-level `import` statements"#]],
    )
}
...
fn report_external_item_explicit_path_in_nested_module() {
    check(
        ...
        expect![[r#"
            error at 25..30: cannot use external path here
            | error for 25..30: external paths can only be used in top-level `import` statements"#]],
    )
}
