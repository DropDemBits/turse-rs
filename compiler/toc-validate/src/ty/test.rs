...
fn report_function_type_parameterless_named() {
    check(
        ...
        expect![[r#"
            warn at 9..36: parameterless function types should specify `()`
            | warn for 18..30: add `()` after here
...
fn report_function_type_parameterless_unnamed() {
    check(
        "type _ : function : int",
        expect![[r#"
            warn at 9..23: parameterless function types should specify `()`
            | warn for 9..17: add `()` after here
            | info: referring to a parameterless function will call it instead of producing a reference to it"#]],
    );
}
...
fn report_flexible_array_in_const_decl() {
    check(
        ...
        expect![[r#"
            error at 33..36: unexpected end of file
            | error for 33..36: expected `:=` after here
            error at 10..18: `flexible` is not allowed here
            | error for 10..18: `flexible` arrays cannot be specified in `const` variables
...
fn report_flexible_array_in_type_decl() {
    check(
        ...
        expect![[r#"
            error at 9..17: `flexible` is not allowed here
            | error for 9..17: `flexible` arrays can only be specified in `var` declarations"#]],
    );
}
...
fn report_flexible_array_in_union_field() {
    check(
        ...
        expect![[r#"
            error at 41..49: `flexible` is not allowed here
            | error for 41..49: `flexible` arrays are not allowed in `union` fields
...
fn report_flexible_array_in_record_field() {
    check(
        ...
        expect![[r#"
            error at 22..30: `flexible` is not allowed here
            | error for 22..30: `flexible` arrays are not allowed in `record` fields
...
fn report_set_type_in_var() {
    check(
        ...
        expect![[r#"
            error at 8..22: `set` type is not allowed here
            | error for 8..22: `set` types can only be specified in `type` declarations"#]],
    );
}
...
fn report_union_type_no_variants() {
    check(
        ...
        expect![[r#"
            error at 9..36: missing `union` variants
            | error for 9..36: at least one `union` variant must be present"#]],
    );
}
...
fn report_collection_type_in_const_decl() {
    check(
        ...
        expect![[r#"
            error at 24..27: unexpected end of file
            | error for 24..27: expected `:=` after here
            error at 10..27: `collection` type is not allowed here
            | error for 10..27: `collection` type cannot be specified in a `const` variable
...
fn report_collection_type_in_type_decl() {
    check(
        ...
        expect![[r#"
            error at 9..26: `collection` type is not allowed here
            | error for 9..26: `collection` types can only be specified in `var` declarations"#]],
    );
}
...
fn report_collection_type_in_module_subprogram() {
    check(
        ...
        expect![[r#"
            error at 24..41: `collection` type is not allowed here
            | error for 24..41: `collection` types can only be specified at the top-level of module-likes or programs
...
fn report_collection_type_in_module_inner() {
    check(
        ...
        expect![[r#"
            error at 23..40: `collection` type is not allowed here
            | error for 23..40: `collection` types can only be specified at the top-level of module-likes or programs"#]],
    );
}
...
fn report_condition_type_in_const_decl() {
    check(
        ...
        expect![[r#"
            ...
            | error for 30..33: expected `:=`, but found `end`
            error at 20..29: `condition` type is not allowed here
            | error for 20..29: `condition` type cannot be specified in a `const` variable
...
fn report_condition_type_in_type_decl() {
    check(
        ...
        expect![[r#"
            error at 19..28: `condition` type is not allowed here
            | error for 19..28: `condition` types can only be specified in `var` declarations, or as the `array` element in `var` declarations"#]],
    );
}
...
fn report_condition_type_in_var_decl_array_index() {
    check(
        ...
        expect![[r#"
            error at 24..33: `condition` type is not allowed here
            | error for 24..33: `condition` types can only be specified in `var` declarations, or as the `array` element in `var` declarations"#]],
    );
}
...
fn report_condition_type_in_var_decl_array_array_element() {
    check(
        ...
        expect![[r#"
            error at 50..59: `condition` type is not allowed here
            | error for 50..59: `condition` types can only be specified in `var` declarations, or as the `array` element in `var` declarations"#]],
    );
}
...
fn report_condition_type_in_monitor_subprogram() {
    check(
        ...
        expect![[r#"
            error at 25..34: `condition` type is not allowed here
            | error for 25..34: `condition` types can only be specified at the top-level of monitors
...
fn report_condition_type_in_monitor_inner() {
    check(
        ...
        expect![[r#"
            error at 24..33: `condition` type is not allowed here
            | error for 24..33: `condition` types can only be specified at the top-level of monitors"#]],
    );
}
...
fn report_condition_type_in_module() {
    check(
        ...
        expect![[r#"
            error at 17..26: `condition` type is not allowed here
            | error for 17..26: `condition` types can only be specified at the top-level of monitors"#]],
    );
}
...
fn report_condition_type_in_program() {
    check(
        "var _ : condition",
        expect![[r#"
            error at 8..17: `condition` type is not allowed here
            | error for 8..17: `condition` types can only be specified at the top-level of monitors"#]],
    );
}
