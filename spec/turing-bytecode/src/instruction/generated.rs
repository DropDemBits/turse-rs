...
pub enum Opcode {
    ...
    GESTR = 0x77,
    #[doc = "Get Characters from Stream\n\nGets the given value from the provided `stream` based on interpreting the stream data as characters.\n\nThe actual number of stack arguments is based on `get_kind`, as different get items have different uses for the arguments.\n`get_kind` is also a variably encoded operand, based on interpreting the first `int4` as the tag value.\n\n## Stack Effect\n\n- If `get_kind` == [`get_kind.boolean`](GetKind::Boolean):\n\n  ```text\n  ( dest:addrint stream:addrint -- )\n\n  ```\n\n- If `get_kind` == [`get_kind.char`](GetKind::Char):\n\n  ```text\n  ( dest:addrint stream:addrint -- )\n\n  ```\n\n- If `get_kind` == [`get_kind.char_range`](GetKind::CharRange):\n\n  ```text\n  ( dest:addrint stream:addrint -- )\n\n  ```\n\n- If `get_kind` == [`get_kind.char_n`](GetKind::CharN):\n\n  ```text\n  ( dest:addrint width:int4 stream:addrint -- )\n\n  ```\n\n- If `get_kind` == [`get_kind.enum`](GetKind::Enum):\n\n  ```text\n  ( dest:addrint variant_names:addrint stream:addrint -- )\n\n  ```\n\n- If `get_kind` == [`get_kind.enum_range`](GetKind::EnumRange):\n\n  ```text\n  ( dest:addrint variant_names:addrint stream:addrint -- )\n\n  ```\n\n- If `get_kind` == [`get_kind.int`](GetKind::Int):\n\n  ```text\n  ( dest:addrint stream:addrint -- )\n\n  ```\n\n- If `get_kind` == [`get_kind.int_range`](GetKind::IntRange):\n\n  ```text\n  ( dest:addrint stream:addrint -- )\n\n  ```\n\n- If `get_kind` == [`get_kind.nat`](GetKind::Nat):\n\n  ```text\n  ( dest:addrint stream:addrint -- )\n\n  ```\n\n- If `get_kind` == [`get_kind.real`](GetKind::Real):\n\n  ```text\n  ( dest:addrint stream:addrint -- )\n\n  ```\n\n- If `get_kind` == [`get_kind.string_exact`](GetKind::StringExact):\n\n  ```text\n  ( dest:addrint width:int4 length:nat4 max_length:nat4 stream:addrint -- )\n\n  ```\n\n- If `get_kind` == [`get_kind.string_line`](GetKind::StringLine):\n\n  ```text\n  ( dest:addrint max_length:nat4 stream:addrint -- )\n\n  ```\n\n- If `get_kind` == [`get_kind.string_token`](GetKind::StringToken):\n\n  ```text\n  ( dest:addrint max_length:nat4 stream:addrint -- )\n\n  ```\n\n- If `get_kind` == [`get_kind.skip`](GetKind::Skip):\n\n  ```text\n  ( stream:addrint -- )\n\n  ```"]
    GET = 0x78,
    ...
    PUSHVAL1 = 0xC3,
    #[doc = "Put Characters to Stream\n\nPuts the given value to the provided `stream`.\n\nThe actual number of stack arguments is based on `put_kind`, as different put items have different uses for the arguments.\n\n## Stack Effect\n\n- If `put_kind` == [`put_kind.boolean`](PutKind::Boolean):\n\n  ```text\n  ( value:nat4 width:int4 stream:addrint -- )\n\n  ```\n\n- If `put_kind` == [`put_kind.char`](PutKind::Char):\n\n  ```text\n  ( value:nat1 width:int4 stream:addrint -- )\n\n  ```\n\n- If `put_kind` == [`put_kind.char_n`](PutKind::CharN):\n\n  ```text\n  ( value:addrint length:nat4 width:int4 stream:addrint -- )\n\n  ```\n\n- If `put_kind` == [`put_kind.enum`](PutKind::Enum):\n\n  ```text\n  ( value:nat4 width:int4 variant_names:addrint stream:addrint -- )\n\n  ```\n\n- If `put_kind` == [`put_kind.int`](PutKind::Int):\n\n  ```text\n  ( value:int4 width:int4 stream:addrint -- )\n\n  ```\n\n- If `put_kind` == [`put_kind.int_fract`](PutKind::IntFract):\n\n  ```text\n  ( value:int4 width:int4 fractional_width:int4 stream:addrint -- )\n\n  ```\n\n- If `put_kind` == [`put_kind.int_exp`](PutKind::IntExp):\n\n  ```text\n  ( value:int4 width:int4 fractional_width:int4 exponent_width:int4 stream:addrint -- )\n\n  ```\n\n- If `put_kind` == [`put_kind.nat`](PutKind::Nat):\n\n  ```text\n  ( value:nat4 width:int4 stream:addrint -- )\n\n  ```\n\n- If `put_kind` == [`put_kind.nat_fract`](PutKind::NatFract):\n\n  ```text\n  ( value:nat4 width:int4 fractional_width:int4 stream:addrint -- )\n\n  ```\n\n- If `put_kind` == [`put_kind.nat_exp`](PutKind::NatExp):\n\n  ```text\n  ( value:nat4 width:int4 fractional_width:int4 exponent_width:int4 stream:addrint -- )\n\n  ```\n\n- If `put_kind` == [`put_kind.real`](PutKind::Real):\n\n  ```text\n  ( value:real8 width:int4 stream:addrint -- )\n\n  ```\n\n- If `put_kind` == [`put_kind.real_fract`](PutKind::RealFract):\n\n  ```text\n  ( value:real8 width:int4 fractional_width:int4 stream:addrint -- )\n\n  ```\n\n- If `put_kind` == [`put_kind.real_exp`](PutKind::RealExp):\n\n  ```text\n  ( value:real8 width:int4 fractional_width:int4 exponent_width:int4 stream:addrint -- )\n\n  ```\n\n- If `put_kind` == [`put_kind.string`](PutKind::String):\n\n  ```text\n  ( value:addrint width:int4 stream:addrint -- )\n\n  ```\n\n- If `put_kind` == [`put_kind.skip`](PutKind::Skip):\n\n  ```text\n  ( stream:addrint -- )\n\n  ```"]
    PUT = 0xC4,
